...
public class SecurityConfig {
    ...
    public class CustomSecurityFileterManager extends AbstractHttpConfigurer<CustomSecurityFileterManager, HttpSecurity> {
        ...
        public void configure(HttpSecurity http) throws Exception {
            AuthenticationManager authenticationManager = http.getSharedObject(AuthenticationManager.class); // 인증 매니저 접근이 가능함.
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .headers((header) -> header.frameOptions(frameOptionsConfig -> frameOptionsConfig.disable() )) // iframe 허용안함.
